...
import { loadJson, loadFile, saveJson, saveFile, sanitizeName, PLATFORM } from 'jnu-abc';
import dotenv from 'dotenv';
dotenv.config({ path: `../.env.${PLATFORM}` });

const { CHROME_DEFAULT_USER_EMAIL, CHROME_DEFAULT_USER_DATA_DIR, CLASS101_HTML_ROOT, CLASS101_JSON_ROOT } = process.env;
